...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{graph/heatmap.png}
    \caption{Heatmap of China} \label{Figure 4}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{graph/Correlation of CHN with Programs.png}
...
%   $\Delta G$ represents the change in gold medals;
% 	 $\DeltaS$ represents the change in silver medals;
% 	 $\DeltaB$ represents the change in bronze medals;
%  $w_G$,$w_S$,$w_B$ are the weight coefficients for gold, silver, and bronze medals, used to quantify the impact of each medal type on the coach’s effect.
