...
\begin{figure}[htbp]
    \centering
    \subfloat[]{
    \includegraphics[width=6cm]{screencut 2025-01-22 145607.png}}
    \subfloat[]{
        \includegraphics[width=6cm]{screencut 2025-01-22 145612.png}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{screencut 2025-01-22 145616.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{D:/github/MCM/test/kacey/picture/150626.png}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{1\linewidth}
        \subfloat[] {
            \includegraphics[width=0.49\linewidth,height=1.2in]{{D:/github/MCM/test/kacey/picture/2.1.png}
        }
        \subfloat[] {
            \includegraphics[width=0.49\linewidth,height=1.2in]{D:/github/MCM/test/kacey/picture/2.2.png}
        }
    \end{minipage}
    \vskip -0.3cm
    \begin{minipage}{1\linewidth}
        \subfloat[] {
            \includegraphics[width=0.49\linewidth,height=1.2in]{D:/github/MCM/test/kacey/picture/2.3.png}
        }
        \subfloat[] {
            \includegraphics[width=0.49\linewidth,height=1.2in]{D:/github/MCM/test/kacey/picture/2.4.png}
        }
    \end{minipage}
    \vspace{-0.18in}
...
\begin{figure}[htbp]
    \centering
    \subfloat[]{
        \includegraphics[width=6cm]{D:/github/MCM/test/kacey/picture/scatter1.png}
    }
    \subfloat[]{
        \includegraphics[width=6cm]{D:/github/MCM/test/kacey/picture/scatter2.png}
    }
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{D:/github/MCM/test/kacey/picture/154248.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{D:/github/MCM/test/kacey/picture/154253.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{screencut 2025-01-22 160249.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{screencut 2025-01-22 163353.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{变化.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{screencut 2025-01-22 164913.png}
